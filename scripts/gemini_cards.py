...
### 基础规格
- 图片比例：16:9 横版
- 背景：暖白色 (#F8F7F4)，略带高级纸张质感

### 配色方案
- 主色调：深蓝灰 (#2C3E50) - 用于标题背景、重点色块
- 辅助色：柔和蓝 (#3498DB) - 用于连接线、图标
- 强调色：琥珀橙 (#F39C12) - 用于高亮、重点标记
- 浅色背景：薄荷绿 (#E8F6F3)、浅蓝 (#EBF5FB) - 用于区域背景
- 文字颜色：深灰 rgba(0,0,0,0.85)，避免纯黑
- 禁止使用：霓虹色、纯黑色、高饱和色
